    ...
    d3.helper.tooltip = function(){
        ...
        function tooltip(selection){
            ...
            selection.on('mouseover.tooltip', function(pD, pI){
                ...
                tooltipDiv.style('width', function(d, i){ return (text(pD, pI).length > 80) ? '150px' : null; })
            ...
            .on('mousemove.tooltip', function(pD, pI){
                ...
                tooltipDiv.style(
                    "left", function(pD, pI) {
                    if (absoluteMousePos[0]>200) {return ''+(absoluteMousePos[0] - 165)+'px'}
                    else {return ''+(absoluteMousePos[0] + 10)+'px'}
                    })
                tooltipDiv.style(    
                    "top", function(pD, pI) {
                    if (absoluteMousePos[0]>200) {return ''+(absoluteMousePos[1] - 15)+'px'}
